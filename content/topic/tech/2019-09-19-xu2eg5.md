...
- Python玩家，《[自制一个python下载文件的进度条模块！](https://blog.csdn.net/programmer_yf/article/details/80512428)》，CSDN
- 微寒Super，《[Python3使用requests模块显示下载进度](https://blog.csdn.net/supercooly/article/details/51046561)》，CSDN
- Kenneth Reitz，《[高级用法 — Requests 2.18.1 文档](http://cn.python-requests.org/en/latest/user/advanced.html)》，Requests 2.18.1 文档
- 昊天 seo，《[Python3 使用requests模块显示下载视频并且显示进度](https://www.168seo.cn/python/24286.html)》，WordPress 博客
